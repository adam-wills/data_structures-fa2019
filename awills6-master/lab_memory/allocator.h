...
class Allocator
{
  public:
    ...
    /**
     * Allocator destructor (frees stuff)
     */
    ~Allocator();

    /**
     * Copy contstructor (implemented as part of "rule of three")
     */
    Allocator(const Allocator& other);

    /**
     * Assignment operator (implemented as part of "rule of three")
     */
  ...
  private:
    ...
    /**
     * deep copy function for use with assignment operator and copy constructor
     */
    void copyAllocator(const Allocator& other);

    /**
     * clear function for use with assignment operator and destructor
     */
    void clearAllocator();
